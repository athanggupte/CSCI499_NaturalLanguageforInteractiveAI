...
class Decoder(nn.Module):
    ...
    def forward(self, y, y_lens, h_enc, c_enc):
        '''
        y : in case of student-forcing, y is a single pair of (<start>_act, <start>_tar) tokens
...
class EncoderDecoder(nn.Module):
    ...
    def forward(self, x, x_lens, y=None, y_lens=None, max_out_len=25):
        ...
        if y is not None:
            ...
            # outputs : (batch_size, out_seq_len, len(a2i) + len(t2i))
